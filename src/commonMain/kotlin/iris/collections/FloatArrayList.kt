...
fun FloatList.average(): Double {
    if (isEmpty()) return Double.NaN
    return sum().toDouble() / size
}


fun FloatList.minOrNull(): Float? {
...
fun FloatList.first(): Float {
    if (isEmpty()) throw NoSuchElementException("Empty FloatList")
    return this[0]
}

fun FloatList.last(): Float {
    if (isEmpty()) throw NoSuchElementException("Empty FloatList")
    return this[lastIndex]
}

fun FloatList.firstOrNull(): Float? = if (isEmpty()) null else this[0]
fun FloatList.lastOrNull(): Float? = if (isEmpty()) null else this[lastIndex]
